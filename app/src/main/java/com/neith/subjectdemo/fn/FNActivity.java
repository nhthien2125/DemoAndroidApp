...
import com.neith.subjectdemo.fn.data.FinanceDbHelper;
...
public class FNActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLuuHanMuc.setOnClickListener(v -> {
            ...
            if (!hanMucStr.isEmpty()) {
                // Sử dụng SharedPrefsManager thay vì thao tác trực tiếp
                prefsManager.saveHanMuc(Float.parseFloat(hanMucStr));
    ...
    private void capNhatThongKe() {
        float hanMuc = prefsManager.getHanMuc();
